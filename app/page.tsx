      ...
      <div style={{ maxWidth: '650px', margin: '0 auto', position: 'relative' }}>
        ...
        {!isSetupComplete ? (
          <div>
            ...
            {/* ROULETTE EXPRESS AVEC ACTIONS DIRECTES */}
            <div style={{ 
              ...
              {rouletteMedia && !isSpinning && (
                <div style={{ marginTop: '16px', backgroundColor: 'rgba(24, 24, 27, 0.95)', border: '1px solid rgba(251, 191, 36, 0.3)', borderRadius: '16px', padding: '16px', textAlign: 'left' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px' }}>
                    <img src={`https://image.tmdb.org/t/p/w500${rouletteMedia.poster_path}`} alt="" style={{ width: '60px', height: '85px', objectFit: 'cover', borderRadius: '8px' }} />
                    <div style={{ flex: 1 }}>
                      <span style={{ fontSize: '10px', color: '#FBBF24', fontWeight: '700' }}>🎯 Résultat de la roulette :</span>
                      <h4 style={{ fontSize: '15px', fontWeight: '800', margin: '2px 0 4px 0', color: '#FFF' }}>{rouletteMedia.title || rouletteMedia.name}</h4>
                      <span style={{ fontSize: '11px', color: '#A1A1AA' }}>★ {rouletteMedia.vote_average?.toFixed(1)} / 10</span>
                    </div>
                    <button 
                      onClick={() => openMediaModal(rouletteMedia)}
                      style={{ backgroundColor: 'rgba(255,255,255,0.1)', color: '#FFF', border: 'none', padding: '6px 10px', borderRadius: '8px', fontSize: '10px', fontWeight: '700', cursor: 'pointer' }}
                    >
                      Détails ⚡
                    </button>
                  </div>

                  {/* BOUTONS D'ACTION RAPIDE SUR LA ROULETTE */}
                  <div style={{ display: 'flex', gap: '8px', paddingTop: '8px', borderTop: '1px solid rgba(255,255,255,0.1)' }}>
                    <button 
                      ...
                      style={{ flex: 1, backgroundColor: 'rgba(255, 255, 255, 0.1)', color: '#FFF', border: 'none', padding: '8px', borderRadius: '10px', fontSize: '11px', fontWeight: '700', cursor: 'pointer' }}
                    >
                      👁️ Marquer comme Vu
                    </button>
                    <button 
                      ...
                      style={{ flex: 1, backgroundColor: '#9333EA', color: '#FFF', border: 'none', padding: '8px', borderRadius: '10px', fontSize: '11px', fontWeight: '700', cursor: 'pointer' }}
                    >
                      📌 Ajouter Watchlist
                    </button>
                  </div>
